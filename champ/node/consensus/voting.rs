...
//
// Conclusion:
// I think after each ValidationError in block.rs we should need to call a vote. (exclude some errs like tooManyTrx)
...
// ! Important, if no block is put forward, use that as a block to avoid false blocks
